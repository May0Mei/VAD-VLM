...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        text_feature_encoder='st', #ABLATE: st, clip
        map_thresh=0.5,
        dis_thresh=0.2,
        ...
        ego_agent_decoder=dict(
            type='CustomTransformerDecoder_ego_agent_planning_st',
            num_layers=1,
        ...
        ego_map_decoder=dict(
            type='CustomTransformerDecoder_ego_map_planning_st',
            num_layers=1,
            return_intermediate=False,
            transformerlayers=dict(
                type='BaseTransformerLayer',
                ...
                operation_order=('cross_attn', 'norm', 'ffn', 'norm'))),
        motion_decoder=dict(
            type='CustomTransformerDecoder_Motion_his_agent_agent_st',
            num_layers=1,
            return_intermediate=False,
            transformerlayers=dict(
                type='BaseTransformerLayer',
        ...
        motion_map_decoder=dict(
            type='CustomTransformerDecoder_Motion_his_agent_map_st',
            num_layers=1,
            return_intermediate=False,
            transformerlayers=dict(
                type='BaseTransformerLayer',
...
vlm_ann_path = '/n/fs/not-fmrl/Projects/ActivePerception-FMRL/vlm_dicts_processed/0327_vlm_dicts_processed_st.pkl' #ABLATE: 7B, adversarial, encoder
...
data = dict(
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             pc_range=point_cloud_range,
             ann_file=data_root_ann + 'vad_nuscenes_infos_temporal_val.pkl',
