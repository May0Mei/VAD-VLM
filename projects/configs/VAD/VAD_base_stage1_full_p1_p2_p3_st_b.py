...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        text_feature_encoder='st_b', #ABLATE: st, clip
        map_thresh=0.5,
        dis_thresh=0.2,
...
vlm_ann_path = '/n/fs/not-fmrl/Projects/ActivePerception-FMRL/vlm_dicts_processed/0327_vlm_dicts_processed_st_b.pkl' #ABLATE: 7B, adversarial, encoder
...
data = dict(
    samples_per_gpu=2, # batch size 2?
    workers_per_gpu=4,
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ...
        keep_frame_idx = None, #full dataset
